...
from .tone_mapper import GaussianGRUToneMapper
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, gaussian_dim : int = 3, time_duration: list = [-0.5, 0.5], rot_4d: bool = False, force_sh_3d: bool = False, sh_degree_t : int = 0):
        ...
        self.tone_mapper = GaussianGRUToneMapper()
    ...
    def restore(self, model_args, training_args):
        ...
        if training_args is not None:
            ...
            self.tone_mapper.load_state_dict(tone_mapper_dict)
    @property
    ...
    def create_from_pth(self, path, spatial_lr_scale):
        ...
        print("Found number of points at initialization from pth: ", fused_point_cloud.shape[0])
    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            {'params': self.tone_mapper.parameters(), 'lr': training_args.tone_mapper_lr, "name": "tone_mapper"},
        ]
